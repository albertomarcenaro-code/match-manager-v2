...
export const WhatsAppShareButton = ({ state }: WhatsAppShareButtonProps) => {
  ...
  return (
    ...
    >
      <span className="flex items-center justify-center h-14 w-14 rounded-full bg-[#25D366] text-white shadow-md transition-transform group-hover:scale-110 group-active:scale-95">
