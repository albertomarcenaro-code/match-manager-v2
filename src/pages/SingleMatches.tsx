...
export default function SingleMatches() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Helmet>
        <title>Partite Singole | Match Manager Live</title>
        <meta name="description" content="Crea nuove partite e consulta lo storico delle partite singole gestite con Match Manager." />
      </Helmet>
      <Header />
