...
-- saved_teams
DROP POLICY IF EXISTS "Users can view their own saved teams" ON public.saved_teams;
DROP POLICY IF EXISTS "Users can insert their own saved teams" ON public.saved_teams;
DROP POLICY IF EXISTS "Users can update their own saved teams" ON public.saved_teams;
DROP POLICY IF EXISTS "Users can delete their own saved teams" ON public.saved_teams;
